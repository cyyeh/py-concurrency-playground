...
if __name__ == '__main__':
    ...
    print(f'[naive version]: Downloaded {len(sites)} in {duration} seconds')
    ...
    print(f'[threading version]: Download {len(sites)} in {duration} seconds with maximum {max_workers} workers')
